...
:root {
  ...
  --color-panel:       #1f1c19;
  --color-rule:        #2a2622;
  --color-rule-soft:   #221f1c;
  --color-chalk:       #ebe5d8;
  --color-chalk-dim:   #a8a094;
  --color-chalk-faint: #5a564f;
  --color-blood:       #a8211a;
...
**Section eyebrow:**
`▮` character (U+25AE, BLACK VERTICAL RECTANGLE) in `--color-blood`,
followed by section name in JetBrains Mono 500, 11px, uppercase,
`letter-spacing: 0.2em`, `--color-blood`. Margin-bottom: 12px.
