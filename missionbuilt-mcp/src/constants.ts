 ...
 *   SPOTTER_VERSION       — Spotter skill version; bump when SKILL.md or lenses change
 */

export const SERVER_VERSION        = "1.0.0";
export const WARMUP_VERSION        = "0.3.16";
export const WARMUP_ENGINE_VERSION = "v0.3.12";
export const SPOTTER_VERSION       = "0.5.0";
